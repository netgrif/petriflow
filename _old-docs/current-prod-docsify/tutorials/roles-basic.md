...
<a href="img/roles-basic/example.xml" download="example" style="color:blue;">Download the process</a>
...
<a href="img/roles-basic/roles.xml" download="roles" style="color:blue;">Download the process</a>
