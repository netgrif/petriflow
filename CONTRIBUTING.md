...
Intetion of the language development and research is to remove gap between standard programming languages (like Java, C,
Javascript etc.)
and business world.

Every feature in Petriflow language must have a clear intetion to push the language forward to the ultimate goal, to be
the best low code language
...
* If you can't find an open issue that describes your
  problem, [open a new one](https://github.com/netgrif/petriflow/issues/new).
...
[issues](https://github.com/netgrif/petriflow/issues?q=is%3Aissue+label%3Aenhancement) to check we're not already
tracking it, or that your idea
...
Do not be affraid of regection, every excelent idea has to start somewhere. Give it a well discrebe solution to problem
what your proposition is trying to solve.

Remember, a good Petriflow feature is one that extends the capabilities of the language *and* allows developers to
further enahnce their applications.
