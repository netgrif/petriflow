...
![Types of task and data events](/guides/events-basic/1.png)
...
<video controls style="max-width: 750px;">
  <source src="/guides/events-basic/1.mp4" type="video/mp4">
</video>

_Example of actual task events inside NAE:_

<video controls style="max-width: 750px;">
  <source src="/guides/events-basic/2.mp4" type="video/mp4">
</video>

_Process used in examples above:_

<a href="/guides/events-basic/task.xml" download="request" style="color:blue;">Download the process</a>
...
![Post phase example](/guides/events-basic/2.png)

_Process used in example above:_

<a href="/guides/events-basic/request.xml" download="request" style="color:blue;">Download the process</a>
...
![Get event example](/guides/events-basic/4.png)

_Execution of process instance with Get and Set actions in NAE:_

<video controls style="max-width: 750px;">
  <source src="/guides/events-basic/3.mp4" type="video/mp4">
</video>
...
![Assigning an action to data](/guides/events-basic/5.png)

_Example of Get data reference action:_

![Get data reference action example](/guides/events-basic/6.png)
...
<a href="/guides/events-basic/setget.xml" download="setget" style="color:blue;">Download the process</a>
    ...
    <event type="finish">
      ...
      <actions phase="post">
        <action>answer: f.text_6,
          ...
          make answer,visible on status_task when { true }
        </action>
      </actions>
    </event>
  </transition>
