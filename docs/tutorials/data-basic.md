...
<ol>
    <li> <b>ID.</b> By default, the ID is generated by builder, but you can change it using "Refactor field ID" button.</li>
    <li> <b>Title.</b></li>
    ...
    <li> <b>Set Init Value.</b> Sets an initial value for every use of the data variable.</li>
