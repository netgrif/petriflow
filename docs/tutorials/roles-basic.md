...
<ol>
    ...
    <li>In order to create a new role inside the Role edit view, you need to click the "Add role" button. After the role was created open the role and specify its ID (by default it is generated, but you can change it) and Title.</li>
...
<ol>
    <li>Log In in to the <a href="https://demo.netgrif.com/" target="_blank">the Demo of the NAE</a>. If you do not have account, Sing Up first.</li>
    <li>Once you are logged in go to section Processes in the left navigation menu.</li>
    <li>In the section, Processes click the upload button on the bottom right side of the screen.</li>
    <li>In the right overlay section press button "Choose a process file".</li>
    <li>Upload exported file, that was generated by Netgrif Application Builder. And then press the button "Done".</li>    
    <li>Now you can go to the section All cases in the left navigation menu.</li>
    <li>In the section, All cases click plus button on the top right side of the screen.</li>
