...
<ol>
    <li>Log In in to the <a href="https://demo.netgrif.com/" target="_blank">Demo of the NAE</a>. If you do not have account, Sing Up first.</li>
    <li>Once you are logged in go to section Processes in the left navigation menu.</li>
    <li>In the section Processes click upload button in bottom right side of the screen.</li>
    <li>In the right overlay section press button "Choose a process file".</li>
    <li>Upload exported file, that was generated by Netgrif Application Builder. And then press button "Done".</li>    
    <li>Now you can go to section All cases in the left navigation menu. </li>
    <li>In the section All cases click plus button in top right side of the screen.</li>
    <li>If only one process was uploaded, there is no need to specify the process you want to choose. If there are multiple processes choose the one called "Roles tutorial".</li>
...
In order to play with the roles of your process in <a href="https://demo.netgrif.com/" target="_blank">Demo of the Netgrif Application Engine</a> follow steps:
<ol>
    <li>Once you are logged in go to section Role management in the left navigation menu.</li>
    <li>In the section Role management choose a user (user that is representing you in this case) from the left side of screen to who you want to change roles.</li>
    <li>In the section Role management choose a process (your uploaded process in this case) from the right side of the screen. Now choose roles of the process that you want assign to selected user.</li>
    <li>If you have assigned roles to user, go to the section All cases. Open the process instance that you have crated in pervious steps and check if the user can see any task.</li>
    <li >
</ol>
